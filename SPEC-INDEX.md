...
| `6.0` | &nbsp;&nbsp;The glow, and the one thing that cannot be shared | `SPEC.md` | 975-1005 |
| `6.1` | &nbsp;&nbsp;NWS watch/warning products are the second fixed contract | `SPEC.md` | 1006-1028 |
| `7` | Layer model | `SPEC-MAP.md` | 19-46 |
| `7` | Layer model | -> `SPEC-MAP.md` | SPEC.md:1029 |
...
| `8` | Home | -> `SPEC-UI.md` | SPEC.md:1034 |
| `9` | Design | `SPEC-MAP.md` | 905-906 |
| `9` | Design | -> `SPEC-MAP.md` | SPEC.md:1039 |
...
| `9.14` | &nbsp;&nbsp;Storm light on the backdrop | `SPEC-MAP.md` | 1789-1846 |
| `10` | Input — touch, mouse, keyboard all first-class | `SPEC.md` | 1045-1113 |
| `11` | Basemap tiles — OpenFreeMap (OpenMapTiles), z8 by design | `SPEC-MAP.md` | 1847-1893 |
| `11` | Basemap tiles | -> `SPEC-MAP.md` | SPEC.md:1114 |
| `11.1` | &nbsp;&nbsp;The two schemas are not interchangeable | `SPEC-MAP.md` | 1894-1916 |
| `11.2` | &nbsp;&nbsp;Administrative furniture — borders and place names | `SPEC-MAP.md` | 1917-2003 |
| `11.3` | &nbsp;&nbsp;The name ladder — each rung overlaps the last | `SPEC-MAP.md` | 2004-2044 |
| `11.4` | &nbsp;&nbsp;`to-number` on a missing property is 0, not null | `SPEC-MAP.md` | 2045-2068 |
| `11.5` | &nbsp;&nbsp;Label collision order is free, and it is load-bearing | `SPEC-MAP.md` | 2069-2090 |
...
| `45.4` | Genesis — what it draws on the globe | `SPEC-MAP.md` | 2091-2137 |
| `45.5` | &nbsp;&nbsp;Failure behaviour | `SPEC-DATA.md` | 1139-1166 |
| `45.6` | &nbsp;&nbsp;Which horizon goes on the globe | `SPEC-MAP.md` | 2266-2283 |
| `45.7` | &nbsp;&nbsp;The standing visual risk | `SPEC-MAP.md` | 2284-2292 |
