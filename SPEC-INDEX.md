...
| `6.0` | &nbsp;&nbsp;One glow, written once | `SPEC.md` | 975-1009 |
| `6.1` | &nbsp;&nbsp;NWS watch/warning products are the second fixed contract | `SPEC.md` | 1010-1032 |
| `7` | Layer model | `SPEC-MAP.md` | 19-46 |
| `7` | Layer model | -> `SPEC-MAP.md` | SPEC.md:1033 |
...
| `8` | Home | -> `SPEC-UI.md` | SPEC.md:1038 |
| `9` | Design | `SPEC-MAP.md` | 905-906 |
| `9` | Design | -> `SPEC-MAP.md` | SPEC.md:1043 |
...
| `10` | Input — touch, mouse, keyboard all first-class | `SPEC.md` | 1049-1103 |
| `11` | Basemap tiles — OpenFreeMap (OpenMapTiles), z8 by design | `SPEC-MAP.md` | 1791-1837 |
| `11` | Basemap tiles | -> `SPEC-MAP.md` | SPEC.md:1104 |
...
| `12` | Code structure rules (summary — full rules live in project instructions) | `SPEC.md` | 1109-1128 |
| `13` | Inherited hard-won rules | `SPEC.md` | 1434-1435 |
| `14` | Roadmap — RETIRED | `SPEC.md` | 1803-1809 |
| `15` | Open decisions — RETIRED | `SPEC.md` | 1810-1816 |
| `16` | Screen architecture | `SPEC-UI.md` | 571-572 |
| `16` | Screen architecture | -> `SPEC-UI.md` | SPEC.md:1817 |
| `17` | Public operation | `SPEC-OPS.md` | 23-24 |
| `17` | Public operation — hardening, scale, and the money question | -> `SPEC-OPS.md` | SPEC.md:1823 |
