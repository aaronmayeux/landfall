 ...
 *
 * Home coordinates never leave the device. That has not changed and does not
 * change. See lib/telemetry.js for the contract that governs all of this.
 *
...
export function snapshot() {
  try {
    ...
    return {
       ...
       * of any kind, and home coordinates still never leave the device.
