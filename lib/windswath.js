...
export function buildFullTrack(input, opts = WIND_SWEEP) {
   ...
   * See the header block: every entry above arrives wrapped into (-180, 180],
   * and the frame below subtracts raw longitudes. This is the last point at
   * which the list is complete and still strictly ordered along travel, which
   * is `onOneBranch`'s precondition. */
...
export const __internals = { leadingOvertaken };
