 ...
 *
 * The American half is NHC's own product (§4.8, §36), and it is live: the
 * relay route `/api/nhc/surge` serves it and `fetchStormGeometry()` joins it
 * as its own slot. Nothing here substitutes for it, in either direction.
 */
