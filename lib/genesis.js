 ...
 *    on it. The raw string is carried through as `sourceBasin` and shown as
 *    provenance in the detail view, which is the honest place for a fact we do
 *    not act on. THIS IS STRONGER THAN A FALLBACK: a fallback still has a
 *    wrong branch to take.
 *
 ...
 *    detail view carries the centroid coordinates and NHC's own basin word
 *    underneath it as the checkable facts. Do not let this drift into anything
 *    that sounds like a designation.
 *
...
/**
 * The patch colour for a risk word, resolved against the live theme.
 *
