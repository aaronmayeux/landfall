...
| `map/radar-layer.js` | 327 | **New in Wave 6, and comfortably under.** Radar as a MapLibre raster tile source: the frame lookup, the tiles template, the coverage sentence and the refresh cadence. No canvas in it at all. |
