...
| `ui/panels.css` | 2236 | **Exempt, and the threshold below it was missed.** See below. |
...
| `ui/view-home.js` | 1413 | **Over the line.** Past ~700 and still growing. Needs an inventory and a cut list before the next home pass — the strength strip, the countdown and the quiet states are three separable concerns sharing one file. |
